...
public class String_Methods {
    /*
    String methods: charAt, +, length, upper,
    lower, trim, substring, replace,
    replaceFirst, indexOf, lastIndexOf, equals,
    equalsIgnorecase, isEmpty, ends, starts, contains
     */
    public static void main(String[] args) {
        ...
        //substring: ENDING INDEX IS EXCLUSED. BEGINNING INDEX IS INCLUSE
